            ...
            <div className="bg-tan-50 h-[700px] flex shadow-md pt-[60px] flex-col-reverse sm:flex-row sm:h-[400px] md:h-[400px] lg:h-[500px]">
                ...
                <div className="flex justify-center flex-col w-[100%] px-[50px] py-[30px] sm:w-[40%] sm:p-[0px] md:w-[50%] lg:w-[40%] m-auto gap-[15px]">
                    ...
                    <div className="flex gap-[15px]">
                        <a href="" target="_blank" rel="noopener noreferrer"><button className="cursor-pointer text-md rounded-md bg-celtic-800 hover:bg-celtic-950 hover:shadow-all-over scale-100 hover:scale-110 transition-all duration-500 ease text-white px-[7px] py-[2px] gap-[2px]"><FontAwesomeIcon className="pr-[3px]" icon={faPaperclip} />Resume</button></a>
